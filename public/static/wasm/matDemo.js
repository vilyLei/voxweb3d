...
var moduleUrl = self.location.href.slice(0,scriptDir.lastIndexOf("/")+1);
var k = moduleUrl.indexOf("http://");
if(k < 0)
{
  k = moduleUrl.indexOf("https://");
}
if(k < 0) k = 0;
moduleUrl = moduleUrl.slice(k) + "static/wasm/";

//var wasmBinaryFile = 'matDemo.wasm';
var wasmBinaryFile = moduleUrl + 'matDemo.wasm';
