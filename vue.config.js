...
if(process.env.npm_lifecycle_script.indexOf("./src/app/modules/") > 0) {
  
  let subStr = process.env.npm_lifecycle_script;
  let i = subStr.indexOf("./src/app/modules/");
  subStr = subStr.slice(i);
  devDstStr = appDstStr = subStr;
}
