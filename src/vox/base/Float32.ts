...
export default class Float32 implements Float32Data {
	private static ___InitData_0 = new Float32Array(32);
	...
	constructor(pfs32: Float32Array = null, index: number = 0) {
		if(Float32.___InitData_1 == null) {
			Float32.___InitData_1 = new Float32Array(32);
			Float32.___InitData_1.fill(1.0);
		}
		this.m_uid = Float32.s_uid++;
		this.m_index = index;
		if (pfs32 != null) {
			this.m_fs32 = pfs32;
