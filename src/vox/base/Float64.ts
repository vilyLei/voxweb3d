...
/////////////////////////////////////////////////////////////////////////////////////////////////
export default class Float64 implements Float32Data {
	private static ___InitData_0 = new Float32Array(64);
	...
	constructor(pfs32: Float32Array = null, index: number = 0) {
		if(Float64.___InitData_1 == null) {
			Float64.___InitData_1 = new Float32Array(64);
			Float64.___InitData_1.fill(1.0);
		}
		this.m_uid = Float64.s_uid++;
		this.m_index = index;
		if (pfs32 != null) {
			this.m_fs32 = pfs32;
			this.m_localFS32 = this.m_fs32.subarray(index, index + 64);
		}
		else {
			this.m_fs32 = new Float32Array(64);
			this.m_fs32.set(Float64.___InitData_0, 0);
	...
	identity(): void {
		this.m_localFS32.set(Float64.___InitData_0, 0);
	}

	identityOne(): void {
		this.m_localFS32.set(Float64.___InitData_1, 0);
	}
	...
	copyFromF32Arr(fs32Arr: Float32Array, index: number = 0): void {
		let subArr: Float32Array = fs32Arr.subarray(index, index + 64);
		this.m_fs32.set(subArr, this.m_index);
	}
	copyFrom(mat_other: Float64): void {
		this.m_localFS32.set(mat_other.getLocalFS32(), 0);
	}
	copyTo(mat_other: Float64): void {
