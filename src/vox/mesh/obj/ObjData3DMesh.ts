...
import * as ObjDataParserT from "../../../vox/mesh/obj/ObjDataParser";
...
import ObjDataParser = ObjDataParserT.vox.mesh.obj.ObjDataParser;
...
export namespace vox
{
    export namespace mesh
    {
        ...
        {
            export class ObjData3DMesh extends MeshBase
            {
