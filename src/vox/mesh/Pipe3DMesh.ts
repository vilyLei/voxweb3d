...
import * as PipeGeometryT from "../../voxmesh/geometry/primitive/PipeGeometry"
...
import PipeGeometry = PipeGeometryT.voxmesh.geometry.primitive.PipeGeometry;

export namespace vox
{
    export namespace mesh
    {
        export class Pipe3DMesh extends MeshBase
        {
