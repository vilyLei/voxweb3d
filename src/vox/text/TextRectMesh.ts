...
export namespace vox
{
    ...
    {
        export class TextRectMesh extends MeshBase
        {
            ...
            private createStrData(charsStr:string):void
            {
                ...
                if(charsTot > 0)
                {
                    H5FontSystem.GetInstance().createCharsTexFromStr(charsStr);
                    this.m_width = -1;
                    this.m_height = 0;
                    ...
                    if(expand)
                    {
                        ...
                        for(; i < charsTot; ++i)
                        {
                            ...
                            ivs[4] += 4;
                            ivs[5] += 4;
                            H5FontSystem.GetInstance().getCharTable().getUV8AndSizeFromChar(charsStr.charAt(i),this.m_uvs,sizeArr,i*8);
