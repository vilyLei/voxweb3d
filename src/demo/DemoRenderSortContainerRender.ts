 ...
 */
export class DemoRenderSortContainerRender {
    constructor() { }
    ...
    initialize(): void {
        console.log("DemoRenderSortContainerRender::initialize()......");
        if (this.m_rscene == null) {
            ...
            this.m_rscene.addEntity(plane, 1);
			//*/
			this.initContainerScene();
        }
    }
	private m_target: IRenderEntityBase = null;
	private initContainerScene(): void {
		...
		this.m_rscene.addEntity(container, 1);
