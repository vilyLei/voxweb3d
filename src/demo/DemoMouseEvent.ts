    ...
    export class DemoMouseEvent
    {
        ...
        initialize():void
        {
            ...
            if(this.m_rscene == null)
            {
                ...
                let tex3:TextureProxy = this.m_texLoader.getImageTexByUrl("static/assets/assets/flare_core_01.jpg");
                let tex4:TextureProxy = this.m_texLoader.getImageTexByUrl("static/assets/assets/flare_core_02.jpg");
                let tex5:TextureProxy = this.m_texLoader.getImageTexByUrl("static/assets/assets/a_02_c.jpg");
