...
import { RedFormatRTTMaterial } from "./material/RedFormatRTTMaterial";
import { RedFormatRTTShowMaterial } from "./material/RedFormatRTTShowMaterial";

export class DemoAlphaFormatFloatRTT {
    ...
    initialize(): void {
        if (this.m_rscene == null) {
            console.log("DemoAlphaFormatFloatRTT::initialize()......");
    ...
    private buildRTT(): void {
        ...
        plane.setMaterial( new RedFormatRTTMaterial() );
        plane.initializeXOZ(-200.0, -150.0, 400.0, 300.0, [tex0]);
        this.m_rscene.addEntity(plane);

        let box = new Box3DEntity();
        box.setMaterial( new RedFormatRTTMaterial() );
