...
class VBuf3ShaderCodeBuffer extends ShaderCodeBuffer {
    ...
    initialize(texEnabled: boolean): void {
        ...
        this.m_uniqueName = "VOX_VBuf3Shd";
...
export default class VBuf3Material extends MaterialBase {

    private static s_shdCodeBuffer: VBuf3ShaderCodeBuffer = null;
    private m_data = new Float32Array([1.0, 1.0, 1.0, 1.0]);
    constructor() {
        super();
        if (VBuf3Material.s_shdCodeBuffer == null) {
            VBuf3Material.s_shdCodeBuffer = new VBuf3ShaderCodeBuffer();
        }
    }
    protected buildBuf(): void {
        
        let buf: VBuf3ShaderCodeBuffer = VBuf3Material.s_shdCodeBuffer;
    }
    /**
    ...
    getCodeBuf(): ShaderCodeBuffer {
        return VBuf3Material.s_shdCodeBuffer;
    }
