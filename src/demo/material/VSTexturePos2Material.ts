...
export namespace demo
{
    ...
    {
        export class VSTexturePos2RenderShaderBuffer extends ShaderCodeBuffer
        {
                constructor()
                {
                    super();
                ...
                {
                    //console.log("VSTexturePos2RenderShaderBuffer::initialize()...");
                    this.m_uniqueName = "VSTexturePos2MaterialShd";
                }
...
`;
                ...
                toString():string
                {
                    return "[VSTexturePos2RenderShaderBuffer()]";
                }
            ...
            export class VSTexturePos2Material extends MaterialBase
            {
                ...
                {
                    return VSTexturePos2RenderShaderBuffer.GetInstance();
                }
