...
export class DemoSubScene {
    ...
    initialize(): void {
        ...
        if (this.m_rscene == null) {
            ...
            let evtCtr = new MouseEvt3DController();
            ...
            let tex3 = this.getTexByUrl("static/assets/flare_core_01.jpg");
            let tex4 = this.getTexByUrl("static/assets/flare_core_02.jpg");
            let tex5 = this.getTexByUrl("static/assets/a_02_c.jpg");
    ...
    private applyEvt(entity: DisplayEntity): void {
        let ctrObj = new DispCtrObj();
        ctrObj.rscene = this.m_rscene;
        ctrObj.name = entity.uuid;
