...
export class DemoParticleRefraction {
    constructor() {
    }
    ...
    initialize(): void {
        console.log("DemoParticleRefraction::initialize()......");
    ...
    parRun(): void {
        if (this.m_flagBoo) {
            if (this.delayTime < 0) {
                ...
                let len: number = 80 + Math.round(Math.random() * 145);
...
export default DemoParticleRefraction;
