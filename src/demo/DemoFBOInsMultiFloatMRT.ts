...
export class DemoFBOInsMultiFloatMRT {
	...
	initialize(): void {
		if (this.m_rscene == null) {
			console.log("DemoFBOInsMultiFloatMRT::initialize()......");
	...
	private buildFBOs(): void {
		...
		particle.initialize(100, 100, [tex2]);
		particle.setXYZ(0, 0, 200);
...
export default DemoFBOInsMultiFloatMRT;
