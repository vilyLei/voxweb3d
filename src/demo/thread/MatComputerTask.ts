...
class MatComputerTask extends ThreadTask {
    ...
    sendData(): void {
        if (this.m_enabled && this.m_fs32Arr != null) {
            ...
            sd.descriptor = {allTot: this.m_matTotal, matTotal: this.m_currMatTotal, flag: 0, calcType: 1};
            this.addData(sd);
...
export { MatCalcSendData, MatComputerTask };