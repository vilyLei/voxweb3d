...
import * as VSTexturePosIdMaterialT from "../../voxanimate/material/VSTexturePosIdMaterial";
...
import * as IdBoxGroupMeshT from "../../voxanimate/mesh/IdBoxGroupMesh";
...
import VSTexturePosIdMaterial = VSTexturePosIdMaterialT.voxanimate.material.VSTexturePosIdMaterial;
...
import IdBoxGroupMesh = IdBoxGroupMeshT.voxanimate.mesh.IdBoxGroupMesh;

export namespace voxanimate
{
    export namespace primtive
    {
        export class IdBoxGroupAnimator extends DisplayEntity
        {
