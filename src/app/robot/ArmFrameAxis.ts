...
export default class ArmFrameAxis {
    ...
    private m_dstLPos: Vector3D = new Vector3D(100, 110);
    private m_dstRPos: Vector3D = new Vector3D(100, 110);
    setAttLPos(pv: Vector3D): void {
        this.m_dstLPos.copyFrom(pv);
    }
    setAttRPos(pv: Vector3D): void {
