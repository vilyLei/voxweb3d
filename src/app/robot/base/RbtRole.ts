...
import * as RoleActModeT from "../../../app/robot/base/RoleActMode";
...
import RoleActMode = RoleActModeT.app.robot.base.RoleActMode;
...
export namespace app
{
    export namespace robot
    {
        ...
        {
            export class RbtRole implements IRunnable
            {
                ...
                private freeRunTest():void
                {
                    if(this.m_staticCount < 1)
                    {
                        ...
                        let pos:Vector3D = this.terrain.getFreePos(this.m_fixPos);
