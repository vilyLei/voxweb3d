    ...
    export class BoFrame
    {
        ...
        initialize():void
        {
            ...
            if(this.m_rscene == null)
            {
                ...
                let tex2 = this.getImageTexByUrl("static/assets/skin_01.jpg");
                let tex3 = this.getImageTexByUrl("static/assets/default.jpg");
                let tex4 = this.m_rscene.textureBlock.createRGBATex2D(16,16,new Color4(1.0,0.0,1.0));
