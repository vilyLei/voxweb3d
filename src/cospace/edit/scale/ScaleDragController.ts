...
export default class ScaleDragController implements IRayControl {
    ...
    setVisible(visible: boolean): void {
        console.log("ScaleDragController::setVisible() ..., visible: ", visible);
    ...
    protected mouseOverListener(evt: any): void {
        console.log("ScaleDragController::mouseOverListener() ...");
        this.showOverColor();
    }
    protected mouseOutListener(evt: any): void {
        console.log("ScaleDragController::mouseOutListener() ...");
        this.showOutColor();
    }
    showOverColor(): void {
    ...
    deselect(): void {
        console.log("ScaleDragController::deselect() ...");
        this.m_flag = -1;
    }
    destroy(): void {
    ...
    mouseDownListener(evt: any): void {
        console.log("ScaleDragController::mouseDownListener() ...");
