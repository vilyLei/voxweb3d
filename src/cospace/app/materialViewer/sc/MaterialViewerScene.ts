...
import { NVTransUI } from "../../normalViewer/ui/NVTransUI";
...
class MaterialViewerScene {
	...
	private selectDisplay(evt: any): void {
		...
		// console.log("MaterialViewerScene::selectDisplay(), evt.uuid: ", evt.uuid);
	...
	private normalScale(evt: any): void {
		// console.log("MaterialViewerScene::normalScale(), evt.uuid: ", evt.uuid, evt.progress);
		// console.log("MaterialViewerScene::normalScale(), evt.progress: ", evt.progress);
		// let mana = this.m_entityManager;
