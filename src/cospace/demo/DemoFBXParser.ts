...
export class DemoFBXParser {
	...
	initialize(): void {
		...
		console.log("DemoFBXParser::initialize()...");
	...
	ctmParseFinish(model: GeometryModelDataType, url: string): void {
		...
		console.log("DemoFBXParser::ctmParseFinish(), model: ", model, ", url: ", url);
	}
