...
import { EntityTestScene } from "./scene/EntityTestScene";

export class DemoEntityTestScene {

	private mRenderingFlag = 0;
	private mWGCtx = new WebGPUContext();
	private mFPS = new RenderStatusDisplay();
	private mRScene = new EntityTestScene();

	constructor() {}

	initialize(): void {
		console.log("DemoEntityTestScene::initialize() ...");
