...
export namespace advancedDemo
{
    export namespace depthFog4
    {
        ...
        {
            class FogSphGeomFactor3ShaderBuffer extends ShaderCodeBuffer
            {
                constructor()
                {
                    super();
                }
                private static ___s_instance:FogSphGeomFactor3ShaderBuffer = new FogSphGeomFactor3ShaderBuffer();
                private m_uniqueName:string = "";
                initialize(texEnabled:boolean):void
                {
                    //console.log("FogSphGeomFactor3ShaderBuffer::initialize()...");
                    this.m_uniqueName = "FogSphGeomFactor3Shd";
                }
...
";
                ...
                toString():string
                {
                    return "[FogSphGeomFactor3ShaderBuffer()]";
                }

                static GetInstance():FogSphGeomFactor3ShaderBuffer
                {
                    return FogSphGeomFactor3ShaderBuffer.___s_instance;
                }
            }
            
            export class FogSphGeomFactor3Material extends MaterialBase
            {
                constructor()
                {
                    super();
                ...
                {        
                    return FogSphGeomFactor3ShaderBuffer.GetInstance();
                }
