...
import * as SceneFogSph2T from "../../advancedDemo/depthFog3/scene/SceneFogSph";
...
import SceneFogSph = SceneFogSph2T.advancedDemo.depthFog3.scene.SceneFogSph;
...
export namespace advancedDemo
{
    export namespace depthFog3
    {
        export class DemoFogSph
        {
            ...
            initialize():void
            {
                //console.log("depthFog3::DemoFogSph::initialize()......");
                if(this.m_rc == null)
                {
            ...
            private m_fogColor:Color4 = new Color4(1.0, 1.0, 1.0,1.0);
            private m_showColor:Color4 = new Color4(0.0, 0.0, 0.0,1.0);
            run():void
            {
