    ...
    export namespace depthFog2
    {
        export namespace material
        {
            class FogSphFactorShaderBuffer extends ShaderCodeBuffer
            {
                ...
                private static ___s_instance:FogSphFactorShaderBuffer = new FogSphFactorShaderBuffer();
                private m_uniqueName:string = "";
                initialize(texEnabled:boolean):void
                {
                    //console.log("FogSphFactorShaderBuffer::initialize()...");
...
";
                ...
                toString():string
                {
                    return "[FogSphFactorShaderBuffer()]";
                }

                static GetInstance():FogSphFactorShaderBuffer
                {
                    return FogSphFactorShaderBuffer.___s_instance;
                }
            }
