...
export class DemoSphOccContainer {
	constructor() {}
	...
	initialize(): void {
		console.log("DemoSphOccContainer::initialize()......");
		if (this.m_rscene == null) {
			...
			srcBox.initializeCube(200, [tex1]);
			//srcBox = null;

			///*
			let box = new Box3DEntity();
			box.initializeCube(30, [tex1]);
			...
			circleFrame.setPosition(box.getPosition());
...
export default DemoSphOccContainer;
