...
class QuadHolePOV implements ISpacePOV {
	...
	setParamFromeBoxFaceZ(minV: Vector3D, maxV: Vector3D): Vector3D[] {
		...
		list[0].setXYZ(minV.x, minV.y, minV.z);
		list[1].setXYZ(minV.x, maxV.y, minV.z);
		list[2].setXYZ(maxV.x, maxV.y, minV.z);
		list[3].setXYZ(maxV.x, minV.y, minV.z);
		list[4].setXYZ(minV.x, minV.y, maxV.z);
		list[5].setXYZ(minV.x, maxV.y, maxV.z);
		list[6].setXYZ(maxV.x, maxV.y, maxV.z);
		list[7].setXYZ(maxV.x, minV.y, maxV.z);
	...
	setParamFromeBoxFaceX(minV: Vector3D, maxV: Vector3D): Vector3D[] {
		...
		list[0].setXYZ(minV.x, minV.y, minV.z);
		list[1].setXYZ(minV.x, maxV.y, minV.z);
		list[2].setXYZ(minV.x, maxV.y, maxV.z);
		list[3].setXYZ(minV.x, minV.y, maxV.z);
		list[4].setXYZ(maxV.x, minV.y, minV.z);
		list[5].setXYZ(maxV.x, maxV.y, minV.z);
		list[6].setXYZ(maxV.x, maxV.y, maxV.z);
		list[7].setXYZ(maxV.x, minV.y, maxV.z);
		//this.setParam(list[0],list[1],list[2],list[3],list[4],list[5],list[6],list[7]);
		this.m_qgPOV0.setParam(this.m_pvList[0], this.m_pvList[1], this.m_pvList[2], this.m_pvList[3]);
