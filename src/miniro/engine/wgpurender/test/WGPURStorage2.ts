...
export class WGPURStorage2 {
	...
	constructor() {}
	initialize(): void {
		console.log("WGPURStorage2::initialize() ...");
	...
	private createRectGeometryData(device: any, pass: any): void {
		...
		console.log("WGPURStorage2::createRectGeometryData() ...");
	...
	private updateWGPUCanvas(clearColor: Color4 = null): void {
		...
		console.log("WGPURStorage2::updateWGPUCanvas() ...");
