...
//  import RcoTextureMaterial from "../../large/material/RcoTextureMaterial";
  ...
  private createMesh(): boolean {
    if (DecodeQueue.MeshDataEanbled) {
      if (DecodeQueue.dst_uid == this.uid) {
        ...
        let tex1: TextureProxy = this.getImageTexByUrl("static/assets/ceil_01.jpg");
