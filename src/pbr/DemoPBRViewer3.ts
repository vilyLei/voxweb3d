...
import { IShaderLibListener, CommonMaterialContext, MaterialContextParam, ShaderCodeConfigure } from "../materialLab/base/CommonMaterialContext";
...
export class DemoPBRViewer3 implements IShaderLibListener {
	...
	constructor() {}
	initialize(): void {
		console.log("DemoPBRViewer3::initialize()......");
	...
	private initMaterialCtx(): void {
		...
		this.m_materialCtx.debugEnabled = false;
		// 启用下面这三句代码,则会产生新的shader bin文件
	...
	private createPBREntity(model: CoGeomDataType, transform: Float32Array = null, uvScale: number = 1.0): void {
		...
		material.setToneMapingExposure(3.0);
		material.setAlbedoColor(1.0, 1.0, 1.0);
		material.setScatterIntensity(1.0);
