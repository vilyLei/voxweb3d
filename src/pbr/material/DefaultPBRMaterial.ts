...
class DefaultPBRPBRShaderBuffer extends ShaderCodeBuffer {
    constructor() {
        super();
    }
    private static ___s_instance: DefaultPBRPBRShaderBuffer = new DefaultPBRPBRShaderBuffer();
    ...
    initialize(texEnabled: boolean): void {
        //console.log("DefaultPBRPBRShaderBuffer::initialize()...");
        this.m_uniqueName = "DefaultPBRPBRShd";
    }
    getFragShaderCode(): string {
        //  console.log("DefaultPBRPBR",DefaultPBRPBR);
        //  console.log("DefaultPBRPBR.frag",DefaultPBRPBR.frag);
        //  console.log("DefaultPBRPBR end.");
...
`;
        ...
        fragCode += "\n";
        let codeHead: string = "";
        if(this.texturesTotal > 2) {
            codeHead = "\nin vec2 v_uv;";
            codeHead += "\nuniform sampler2D u_sampler1;";
            codeHead += "\nuniform sampler2D u_sampler2;";
        } else if(this.texturesTotal > 1) {
            codeHead = "\nin vec2 v_uv;";
            codeHead += "\nuniform sampler2D u_sampler1;";
        }
...
`;
    ...
    toString(): string {
        return "[DefaultPBRPBRShaderBuffer()]";
    }

    static GetInstance(): DefaultPBRPBRShaderBuffer {
        return DefaultPBRPBRShaderBuffer.___s_instance;
    }
}

export default class DefaultPBRPBRMaterial extends MaterialBase {
    ...
    getCodeBuf(): ShaderCodeBuffer {
        let buf: DefaultPBRPBRShaderBuffer = DefaultPBRPBRShaderBuffer.GetInstance();
    ...
    copyFrom(dst:DefaultPBRPBRMaterial): void {
