...
export default class DefaultPBRMaterial extends MaterialBase {
    ...
    getF0(colorFactor: Color4): void {
        ...
        colorFactor.r = this.m_F0[0];
        colorFactor.g = this.m_F0[1];
        colorFactor.b = this.m_F0[2];
    }
    ...
    createSelfUniformData(): ShaderUniformData {
        ...
        oum.uniformNameList = ["u_albedo", "u_params", "u_lightPositions", "u_lightColors", "u_camPos", "u_F0", "u_mirrorProjNV"];
        oum.dataList = [this.m_albedo, this.m_params, this.m_lightPositions, this.m_lightColors, this.m_camPos, this.m_F0, this.m_mirrorProjNV];
        return oum;
    }
}