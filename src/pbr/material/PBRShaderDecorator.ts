...
export default class PBRShaderDecorator {
	...
	initWithParam(param: PBRDecoratorParam): void {
		...
		if (feature) {
			this.specularEnvMapEnabled = feature.specularEnvMapEnabled;
			this.diffuseMapEnabled = feature.diffuseMapEnabled;
			this.mirrorProjEnabled = feature.mirrorProjEnabled;
			this.indirectEnvMapEnabled = feature.indirectEnvMapEnabled;
			this.aoMapEnabled = feature.aoMapEnabled;
			this.scatterEnabled = feature.scatterEnabled;
		}
		let tex = param.texture;
		if (tex) {
			this.specularEnvMap = tex.specularEnvMap;
			this.diffuseMap = tex.diffuseMap;
			this.normalMap = tex.normalMap;
			this.mirrorMap = tex.mirrorMap;
			this.indirectEnvMap = tex.indirectEnvMap;
			this.parallaxMap = tex.parallaxMap;
			this.aoMap = tex.aoMap;
			this.roughnessMap = tex.roughnessMap;
			this.metalhnessMap = tex.metalhnessMap;
			this.iorMap = tex.iorMap;
			this.armMap = tex.armMap;
		}
	}
