...
class MeshoptDecoder {
	...
	initialize(): any {
		...
		var promise = WebAssembly.instantiate(this.unpack(wasm), {}).then(function(result) {
		...
		return {
			...
			decodeVertexBuffer: (target: any, count: any, size: any, source: any, filter: any):void => {
				console.log("use MeshoptDecoder::decodeVertexBuffer() ...");
				this.decode(this.instance.exports.meshopt_decodeVertexBuffer, target, count, size, source, instance.exports[filters[filter]]);
			},
			decodeIndexBuffer: (target: any, count: any, size: any, source: any): void => {
				console.log("use MeshoptDecoder::decodeIndexBuffer() ...");
				this.decode(this.instance.exports.meshopt_decodeIndexBuffer, target, count, size, source);
			},
			decodeIndexSequence: (target: any, count: any, size: any, source: any): void => {
				console.log("use MeshoptDecoder::decodeIndexSequence() ...");
				this.decode(instance.exports.meshopt_decodeIndexSequence, target, count, size, source);
			},
			decodeGltfBuffer: (target: any, count: any, size: any, source: any, mode: any, filter: any):void => {
				console.log("use MeshoptDecoder::decodeGltfBuffer() ...");
				this.decode(instance.exports[decoders[mode]], target, count, size, source, instance.exports[filters[filter]]);
			}
		};
	}
	unpack(data: any): any {
	...
	decode(fun: any, target: any, count: any, size: any, source: any, filter?: any): void {
		var sbrk = this.instance.exports.sbrk;
		var count4 = (count + 3) & ~3; // pad for SIMD filter
		var tp = sbrk(count4 * size);
		var sp = sbrk(source.length);
		var heap = new Uint8Array(this.instance.exports.memory.buffer);
		heap.set(source, sp);
