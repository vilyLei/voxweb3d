...
export class ModelDataDownload {
	...
	initialize(): void {
		...
		if (this.m_rscene == null) {
			...
			// rparam.setCamPosition(5.0, 5.0, 5.0);
	...
	private initSomePrimitives(): void {
		let cone = new Cone3DEntity();
		cone.initialize(10, 30, 3, [this.getTexByUrl("static/assets/box.jpg")]);
		console.log("mesh: ", cone.getMesh());
		this.m_rscene.addEntity(cone);
		// [(0, 2, 1), (0, 3, 2), (0, 1, 3), (5, 8, 4), (6, 9, 5), (4, 7, 6)]
		// [0, -15, 0, 0, -15, 10, 8.6, -15, -5, -8.6, -15, -5, 0, -15, 10, 8.6, -15, -5, -8.6, -15, -5, 0, 15, 0, 0, 15, 0, 0, 15, 0]
		// [(0, -15, 0), (0, -15, 10), (8.6, -15, -5), (-8.6, -15, -5), (0, -15, 10), (8.6, -15, -5), (-8.6, -15, -5), (0, 15, 0), (0, 15, 0), (0, 15, 0)]
		let mesh = cone.getMesh();
		// let fio = new FileIO()
		// fio.downloadBinFile(mesh.getIVS(),"geom01_ivs","bin")
		// fio.downloadBinFile(mesh.getVS(),"geom01_vs","bin")
		// fio.downloadBinFile(mesh.getUVS(),"geom01_uvs","bin")
	}
	private downloadModel(model: CoGeomDataType): void {
		let fio = new FileIO()
		// fio.downloadBinFile(mesh.getIVS(),"geom01_ivs","bin")
		fio.downloadBinFile(model.vertices,"vertices","bin")
		fio.downloadBinFile(model.uvsList[0],"uv","bin")
