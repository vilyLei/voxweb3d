...
void main() {
    ...
    //FragColor0 = vec4((color.xyz * 0.5 + vec3(0.5) ) * vec3(ao), 1.0);
    //FragColor0 = vec4(color.xyz * vec3(ao), 1.0);
    //FragColor0 = vec4(color.xyz * vec3(ao * ao), 1.0);
    //FragColor0 = vec4(color.xyz * vec3(ao), 1.0);
    //FragColor0 = vec4(vec3(ao * ao * ao), 1.0);
    FragColor0 = vec4(mix(vec3(0.0), color.xyz, ao * ao), 1.0);
}
`
                        );
